...
def generate_initial_swarm(
    ...
    Returns:
        best_particle (tuple[float, int, set[int]]): Objective value, number of aisles, and aisle set of the best particle found.
    """
    ...
    return (best_obj, best_n_aisles, best_position.copy())
